...
**Traffic Information Service (TIS) ^4-5-6**
...
1.  **Introduction.**
    ...
    4.  In general, operators flying at 18,000 feet and above (Class A airspace) are required to have 1090ES equipment. Those that do not fly above 18,000 may use either UAT or 1090ES equipment. (Refer to [[Volume 2/F Air traffic and general operating rules/0091 General operating and flight rules.md#§91.225   Automatic Dependent Surveillance-Broadcast (ADS-B) Out equipment and use.|14 CFR §§ 91.225]] and 91.227.) While the regulations do not require it, operators equipped with ADS-B In will realize additional benefits from ADS-B broadcast services: Traffic Information Service – Broadcast (TIS-B) (Paragraph 4-5-8) and Flight Information Service - Broadcast (FIS-B) (Paragraph 4-5-9). <em>
        <div>
